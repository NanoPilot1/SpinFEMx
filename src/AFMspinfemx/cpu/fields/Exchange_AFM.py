...
class ExchangeField:
    """
    Full two-sublattice AFM exchange operator for an AFM.
    ...
    The continuum exchange model follows the two-sublattice formulation
    described by Moreels et al., “mumax+: extensible GPU-accelerated
    micromagnetics and beyond”, npj Computational Materials 12, 71 (2026).
